...
export const JOURNEY_CHAPTERS: JourneyChapter[] = [
  { id: 'first-notes', number: 1, title: 'First Notes', subtitle: 'Right hand melodies, then your first two-hand piece', color: '#22d3ee' },
...
export const JOURNEY_STEPS: JourneyStep[] = [
  // Chapter 1: First Notes — right hand only, then first both-hands
  { type: 'linear', id: 'step-1', chapterId: 'first-notes', order: 1, songId: 'twinkle-twinkle',
    teaches: 'Your very first melody — just 6 notes, right hand only',
    description: 'The most famous melody in the world. Play it with your right hand to learn where the notes are on the keyboard. Just six notes: C, D, E, F, G, A.' },
  { type: 'linear', id: 'step-2', chapterId: 'first-notes', order: 2, songId: 'hot-cross-buns',
    teaches: 'Simple rhythm, only 3 notes, right hand only',
    description: 'Even simpler than Twinkle — just three notes (C, D, E) in a catchy rhythm. Focus on keeping a steady beat.' },
  { type: 'linear', id: 'step-3', chapterId: 'first-notes', order: 3, songId: 'ode-to-joy',
    teaches: 'A longer melody, stepping patterns, right hand only',
    description: 'Beethoven\'s famous theme from his Ninth Symphony. A longer melody that moves mostly in steps — great preparation for real piano pieces.' },
  { type: 'linear', id: 'step-4', chapterId: 'first-notes', order: 4, songId: 'schumann-melody-op68-1',
    teaches: 'Your first two-hand piece',
    description: 'Schumann wrote his Album for the Young as teaching pieces. This gentle melody introduces your left hand for the first time alongside the right.' },

  // Chapter 2: Growing Confidence — solidifying both hands
  { type: 'linear', id: 'step-5', chapterId: 'growing-confidence', order: 5, songId: 'schumann-march-op68-2',
  ...
  { type: 'linear', id: 'step-6', chapterId: 'growing-confidence', order: 6, songId: 'schumann-humming-op68-3',
  ...
  { type: 'linear', id: 'step-7', chapterId: 'growing-confidence', order: 7, songId: 'schumann-wild-rider-op68-8',
  ...
  { type: 'linear', id: 'step-8', chapterId: 'growing-confidence', order: 8, songId: 'schumann-happy-farmer-op68-10',
  ...
  { type: 'linear', id: 'step-9', chapterId: 'growing-confidence', order: 9, songId: 'burgmuller-candeur-op100-1',
  ...
  // Chapter 3: The Bach Notebook — baroque foundations
  { type: 'linear', id: 'step-10', chapterId: 'bach-notebook', order: 10, songId: 'bach-applicatio-bwv994',
    teaches: 'Finger placement, ornaments',
    description: 'Bach wrote this as his son\'s very first keyboard lesson. It introduces basic finger placement and simple ornaments — trills and turns that decorate a melody.' },
  { type: 'linear', id: 'step-11', chapterId: 'bach-notebook', order: 11, songId: 'bach-menuet-g-bwv-anh114',
  ...
  { type: 'linear', id: 'step-12', chapterId: 'bach-notebook', order: 12, songId: 'bach-menuet-gm-bwv-anh115',
  ...
  { type: 'branch', id: 'step-13', chapterId: 'bach-notebook', order: 13, songChoices: ['bach-musette-bwv-anh126', 'bach-polonaise-gm-bwv-anh119'],
  ...
  // Chapter 4: Classical Masters — sonatina form and classical style
  { type: 'linear', id: 'step-14', chapterId: 'classical-masters', order: 14, songId: 'handel-sonatina-hwv585',
    teaches: 'Classical form, baroque style',
    description: 'A short sonatina by Handel that bridges baroque and classical keyboard style — clarity, elegance, and the dance-like quality of 18th-century music.' },
  { type: 'linear', id: 'step-15', chapterId: 'classical-masters', order: 15, songId: 'mozart-menuet-g-k2',
  ...
  { type: 'linear', id: 'step-16', chapterId: 'classical-masters', order: 16, songId: 'clementi-sonatina-op36-1',
  ...
  { type: 'branch', id: 'step-17', chapterId: 'classical-masters', order: 17, songChoices: ['kuhlau-sonatina-op20-1', 'beethoven-sonata-op49-2-mvt2'],
  ...
  // Chapter 5: Building Artistry — expression, speed, and depth
  { type: 'linear', id: 'step-18', chapterId: 'building-artistry', order: 18, songId: 'burgmuller-arabesque-op100-2',
  ...
  { type: 'linear', id: 'step-19', chapterId: 'building-artistry', order: 19, songId: 'schumann-traumerei-op15-7',
  ...
  { type: 'linear', id: 'step-20', chapterId: 'building-artistry', order: 20, songId: 'satie-gymnopedie-1',
  ...
  { type: 'linear', id: 'step-21', chapterId: 'building-artistry', order: 21, songId: 'bach-invention-1-bwv772',
  ...
  // Chapter 6: The Summit — concert-ready pieces
  { type: 'linear', id: 'step-22', chapterId: 'the-summit', order: 22, songId: 'bach-prelude-c-bwv846',
  ...
  { type: 'linear', id: 'step-23', chapterId: 'the-summit', order: 23, songId: 'chopin-prelude-op28-4',
  ...
  { type: 'linear', id: 'step-24', chapterId: 'the-summit', order: 24, songId: 'beethoven-fur-elise',
  ...
  { type: 'linear', id: 'step-25', chapterId: 'the-summit', order: 25, songId: 'satie-gnossienne-1',
  ...
  { type: 'linear', id: 'step-26', chapterId: 'the-summit', order: 26, songId: 'beethoven-moonlight-mvt1',
