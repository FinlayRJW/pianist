...
export const impressionistSongs: SongCatalogEntry[] = [
  ...
  { id: 'debussy-clair-de-lune', title: 'Clair de Lune', composer: 'Claude Debussy', genre: 'impressionist', difficulty: 4, bpm: 52, durationSec: 300, keySignature: 'Db', tags: ['debussy', 'suite-bergamasque', 'famous', 'two-hands'], mutopiaPath: 'DebussyC/L75/debussy_Ste_Bergamesq_Clair/debussy_Ste_Bergamesq_Clair' },
  { id: 'debussy-arabesque-1', title: 'Arabesque No. 1', composer: 'Claude Debussy', genre: 'impressionist', difficulty: 4, bpm: 72, durationSec: 250, keySignature: 'E', tags: ['debussy', 'arabesque', 'two-hands'], mutopiaPath: 'DebussyC/L66/debussy_Arabesque_1/debussy_Arabesque_1' },
  { id: 'debussy-arabesque-2', title: 'Arabesque No. 2', composer: 'Claude Debussy', genre: 'impressionist', difficulty: 4, bpm: 96, durationSec: 230, keySignature: 'G', tags: ['debussy', 'arabesque', 'two-hands'], mutopiaPath: 'DebussyC/L66/debussy_Arabesque_2/debussy_Arabesque_2' },
];
