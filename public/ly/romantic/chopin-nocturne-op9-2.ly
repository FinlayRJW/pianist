...
obsolete-between-system-space = 3  system-system-spacing.basic-distance = #(/ obsolete-between-system-space staff-space)  score-system-spacing.basic-distance = #(/ obsolete-between-system-space staff-space)
  %ragged-bottom=##f
...
\grace { \once \override DynamicLineSpanner.staff-padding = #3.3 g16\sf\tei [(bf ef]} g4) \p a,16 (bf cf-- bf \accidentalStyle forget cs-4 \accidentalStyle default d-1 g16.-5) f32-4 f4-3 ef8->-2~ ef16 (f ef\prall d-1 ef f	%13
...
\did bf8-1_\fpa\< (d') cs-.-4 ( c32-.-5 b-.-3 bf-.-4 a-.-5 af-. f-. d-. cf-.->) bf d \tuplet 3/2  {\tupletUp \once \override TupletNumber.extra-offset = #'( 0.0 . 1.7 ) \once \override TupletBracket.extra-offset = #'( 0.0 . 1.7 ) g-5  f-4 ef-2\!} ef4.^\markup {  \finger "12" }~ ef8 d ef	%16

\dif f4.-3\p (g4-4 f8) \did f4.-4 (c-1)	%17

<<{ \oneVoice \once \override TextScript.extra-offset = #'( 1.8 . -2.0 )
\tuplet 4/3  { \once \override PhrasingSlur.positions = #'(5.5 . 4) \dif ef8-.-3_\ppt \(  (  ef-. ef-. ef-.)} ef (\did d16-2 ef f16. ef32)\) ef4.   (\ddd bf4.)} 
\\
...
\grace { \once \override DynamicLineSpanner.staff-padding = #3.3 g16\sf\tei [(bf ef]} g4) \p a,16 (bf cf-> bf \accidentalStyle forget cs \accidentalStyle default d-1 \dif g16.->-4 f32) \ddd f4\> ( ef8->-2\!)~ ef16 f (ef\trill \ddd d\< ef f\!	%21
...
\did bf16-1-._\fpa\< ([ \dif d'8-5 \set stemLeftBeamCount = #1 \set stemRightBeamCount = #2  
 cs16-.-4  \set stemLeftBeamCount = #2 c16-.-5 b32-.-4] bf16-.-3 [a-.-5]) af32-!-4 \did a,-1 ( bf-2 b-1 c cs d-1  \tuplet 3/2  {\tupletUp \once \override TupletNumber.extra-offset = #'( 0.0 . 1.5 ) \once \override TupletBracket.extra-offset = #'( 0.0 . 1.5 ) g-4  f-3 ef-2\!} ef2.->-1)	%24
...
ef4.\p~ \(\tuplet 8/6 {\tupletDown ef16 f (ef f ef) \ddd f  ( \< ef f)} g4.\!\) r4 r8	%29
